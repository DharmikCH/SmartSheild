    ...
    <div className="max-w-[820px] mx-auto space-y-6">
      ...
      <div className="border-0 rounded-0 p-0 space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={loadExample}
            className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1a1f2e] border border-[#2a3142] text-gray-300 text-[13px] font-medium rounded-xl hover:bg-[#252d3a] transition-colors"
            id="load-example-btn"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* Error */}
        {error && (
          <div className="flex items-start gap-3 p-4 bg-red-900/20 border border-red-800/40 rounded-xl" id="error-card">
